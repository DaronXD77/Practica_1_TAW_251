...
public class EstudianteServiceImpl implements IEstudianteService { // Define la clase EstudianteServiceImpl que implementa la interfaz IEstudianteService
    ...
    @Override
    public EstudianteDTO actualizarEstudiantePorId(Long id, EstudianteDTO estudianteDTO) {
        ...
        Estudiante estudianteActualizado = estudianteRepository.update(id, estudianteExistente);
    ...
    public EstudianteDTO agregarEstudiante(EstudianteDTO estudianteDTO) {
        ...
        Estudiante estudianteGuardado = estudianteRepository.add(estudiante);
